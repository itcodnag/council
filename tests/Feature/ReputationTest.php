...
class ReputationTest extends TestCase
{
    ...
    /** @test */
    public function a_user_gains_points_when_they_reply_a_thread()
    {
        $thread = create(\App\Thread::class);
    ...
    /** @test */
    public function a_user_lose_points_when_they_reply_to_a_thread_is_deleted()
    {
        $this->signIn();
